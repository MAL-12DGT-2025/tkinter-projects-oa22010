...
add_text = ttk.Label(root, text="Items:", anchor="center")
add_text.grid(row=0, column=0, padx=10, pady=10)

less_text = ttk.Label(root, text="Amount:", anchor="center")
less_text.grid(row=0, column=1, padx=10, pady=10)

cost_text = ttk.Label(root, text="Cost each:", anchor="center")
...
amount_enter_a = ttk.Label(root, text="Lemonade", width=12, anchor="center")
amount_enter_a.grid(row=1, column=0, padx=5, pady=1)

amount_enter_b = ttk.Label(root, text="Pink Flavor", width=12, anchor="center")
amount_enter_b.grid(row=2, column=0, padx=5, pady=1)

amount_enter_c = ttk.Label(root, text="Large cup", width=12, anchor="center")
amount_enter_c.grid(row=3, column=0, padx=5, pady=1)

amount_enter_d = ttk.Label(root, text="Straw", width=12, anchor="center")
amount_enter_d.grid(row=4, column=0, padx=5, pady=1)

amount_enter_e = ttk.Label(root, text="Ice", width=12, anchor="center")
